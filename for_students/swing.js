...
export class Swing extends GrObject {
  ...
  constructor(params = {}) {
    ...
    let map1 = loader.load("./textures/rust.jpg");
  ...
  stepWorld(delta, timeOfDay) {
    ...
    this.hanger.rotation.z = (Math.sin(this.swing_angle) * Math.PI) / 16/ this.strenth;
    this.seat.rotation.z = (Math.sin(this.swing_angle) * Math.PI) / 64/ this.strenth;
  }
}
